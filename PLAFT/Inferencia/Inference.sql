...
WITH pd AS (
    SELECT DISTINCT
        ...
        -- ======================================================
        -- ACELERACION / CAMBIO DE COMPORTAMIENTO
        -- ======================================================
        ...
        -- ======================================================
        -- COHERENCIA ECONOMICA
        -- ======================================================
        TRY_CAST(a.imp_trx_abonosefect_6m AS DOUBLE)
        ...
        -- ======================================================
        -- EXPOSICION AL EXTERIOR (PROPORCIONES)
        -- ======================================================
        ...
        TRY_CAST(a.mto_del_ext_12m AS DOUBLE)
            / NULLIF(TRY_CAST(a.imp_trx_abonosefect_12m AS DOUBLE), 0)
    ...
    FROM d_perm_aws.t_agg_alertas_plaft_hist_bkp a
